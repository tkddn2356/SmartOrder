...
<%--                        <h7 class="card-title mb-2 text-muted">입력하신 별점은 추천시스템을 이용하실때 반영이 됩니다.</h7>--%>
                                    ...
                                    <div class="review_rating">
                                        <fieldset class="rating">
                                            <input type="radio" id="rating_1_star5" name="에그불고기버거세트" value="5"><label
                                                for="rating_1_star5"></label>
                                            <input type="radio" id="rating_1_star4" name="에그불고기버거세트" value="4"><label
                                                for="rating_1_star4"></label>
                                            <input type="radio" id="rating_1_star3" name="에그불고기버거세트" value="3"><label
                                                for="rating_1_star3"></label>
                                            <input type="radio" id="rating_1_star2" name="에그불고기버거세트" value="2"><label
                                                for="rating_1_star2"></label>
                                            <input type="radio" id="rating_1_star1" name="에그불고기버거세트" value="1"><label
    ...
    <%--                        &lt;%&ndash;                                        <img class="card-img-top" src="/resources/img/DetailImage.jpg"&ndash;%&gt;--%>
    <%--                        &lt;%&ndash;                                             alt="Card image cap">&ndash;%&gt;--%>
    <%--                        &lt;%&ndash;                                        <div class="card-body">&ndash;%&gt;--%>
    <%--                        &lt;%&ndash;                                            <p class="card-text menu-name">싸이버거 세트</p>&ndash;%&gt;--%>
    <%--                        &lt;%&ndash;                                        </div>&ndash;%&gt;--%>
    <%--                        &lt;%&ndash;                                    </div>&ndash;%&gt;--%>
    <%--                        &lt;%&ndash;                                </div>&ndash;%&gt;--%>
    <%--                        &lt;%&ndash;                                <div class="col-sm-6">&ndash;%&gt;--%>
    ...
    <%--                        &lt;%&ndash;                            </div>&ndash;%&gt;--%>
    <%--                        &lt;%&ndash;                        </div>&ndash;%&gt;--%>
    <%--                        &lt;%&ndash;                        <div id="join_form">&ndash;%&gt;--%>
    <%--                        &lt;%&ndash;                            <div class="review_rating">&ndash;%&gt;--%>
    <%--                        &lt;%&ndash;                                <fieldset class="rating">&ndash;%&gt;--%>
    <%--                        &lt;%&ndash;                                    <input type="radio" id="rating_1_star5" name="rating_1" value="5.0"><label for="rating_1_star5"></label>&ndash;%&gt;--%>
    <%--                        &lt;%&ndash;                                    <input type="radio" id="rating_1_star4" name="rating_1" value="4.0"><label for="rating_1_star4"></label>&ndash;%&gt;--%>
    <%--                        &lt;%&ndash;                                    <input type="radio" id="rating_1_star3" name="rating_1" value="3.0"><label for="rating_1_star3"></label>&ndash;%&gt;--%>
    <%--                        &lt;%&ndash;                                    <input type="radio" id="rating_1_star2" name="rating_1" value="2.0"><label for="rating_1_star2"></label>&ndash;%&gt;--%>
    <%--                        &lt;%&ndash;                                    <input type="radio" id="rating_1_star1" name="rating_1" value="1.0"><label for="rating_1_star1"></label>&ndash;%&gt;--%>
...
<script>
    ...
    getRatingShow(randomMenu[count])
    function getRatingShow(menuId) {
        ...
        menuService.getMenuById(menuId, function (result){
            ...
            str += "<input type='radio' id='rating_1_star3' name='" + result.id + "' value='3'><label for='rating_1_star3'></label>";
            str += "<input type='radio' id='rating_1_star2' name='" + result.id + "' value='2'><label for='rating_1_star2'></label>";
            str += "<input type='radio' id='rating_1_star1' name='" + result.id + "' value='1'><label for='rating_1_star1'></label>";
            str += "</fieldset>";
            str += "</div>";
            if(viewCount <5){
    ...
    function requestRating(rating, callback, error) {
